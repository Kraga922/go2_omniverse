...
# # Import the cube-dropping function
...
# #     material_path = Sdf.Path("/World/Cube/Looks/Material")
...
# #         shader.CreateInput("diffuseColor", Sdf.ValueTypeNames.Float3).Set(Gf.Vec3f(1, 0, 0))
...
# from add_to_scene import drop_cube #, make_rigid
...
#         # if (args_cli.custom_env == "Lisbon"):
#         #     cfg_scene = sim_utils.UsdFileCfg(usd_path="./envs/Lisbon.usd")
#         #     cfg_scene.func("/World/Lisbon", cfg_scene, translation=(0.0, 0.0, 0.0))
#     except:
...
# Import the cube-dropping function
#from add_to_scene import drop_cube
...
def setup_custom_env():
    try:
        ...
        if (args_cli.custom_env == "office"):
            cfg_scene = sim_utils.UsdFileCfg(usd_path="./envs/office.usd")
            cfg_scene.func("/World/office", cfg_scene, translation=(0.0, 0.0, 0.0))
        if (args_cli.custom_env == "FullWarehouse3"):
            cfg_scene = sim_utils.UsdFileCfg(usd_path="./envs/FullWarehouse3.usd")
            cfg_scene.func("/World/FullWarehouse3", cfg_scene, translation=(0.0, 0.0, 0.0))
        if (args_cli.custom_env == "FullOffice"):
            cfg_scene = sim_utils.UsdFileCfg(usd_path="./envs/FullOffice.usd")
            cfg_scene.func("/World/FullOffice", cfg_scene, translation=(0.0, 0.0, 0.0))
        ...
        if (args_cli.custom_env == "OfficeSolid"):
            cfg_scene = sim_utils.UsdFileCfg(usd_path="./envs/OfficeSolid.usd")
            cfg_scene.func("/World/OfficeSolid", cfg_scene, translation=(0.0, 0.0, 0.0))
    except:
        print("Error loading custom environment. You should download custom envs folder from: https://drive.google.com/drive/folders/1vVGuO1KIX1K6mD6mBHDZGm9nk2vaRyj3?usp=sharing")
